...
export default function CharterReservePage() {
  ...
  const ui = {
    badge: lang === "tr" ? "Charter Request" : "Charter Request",
    title:
      lang === "tr"
    ...
    formTitle: lang === "tr" ? "Charter Talep Formu" : "Charter Inquiry Form",
    formDesc:
      lang === "tr"
    ...
    charterWeekId: lang === "tr" ? "Uygun Hafta Seçimi" : "Select Available Week",
    charterDurationWeeks: lang === "tr" ? "Kaç Hafta" : "How Many Weeks",
    guestCount: lang === "tr" ? "Kişi Sayısı" : "Guest Count",
    routePreference: lang === "tr" ? "Rota Tercihi" : "Route Preference",
    boatPreference: lang === "tr" ? "Tekne Tercihi" : "Boat Preference",
    skipperRequired: lang === "tr" ? "Skipper Gerekli mi?" : "Skipper Required?",
    ...
    charterWeekLoading:
      lang === "tr" ? "Haftalar yükleniyor..." : "Weeks loading...",
    charterWeekEmpty:
      lang === "tr"
            ...
            <form onSubmit={handleSubmit} className="mt-8 grid gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-[#08131d] px-4 py-4 text-sm text-white outline-none transition placeholder:text-white/35 focus:border-[#67d3ff]"
                  placeholder={
                    lang === "tr" ? "Tekne tercihi" : "Boat preference"
                  }
                />
              </div>
          ...
          <div className="grid gap-6">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-gray-950 p-8 text-white shadow-sm">
              ...
              <div className="mt-6 flex flex-col gap-4 sm:flex-row">
                ...
                >
                  {lang === "tr" ? "Charter Bölümü" : "Charter Section"}
                </Link>
