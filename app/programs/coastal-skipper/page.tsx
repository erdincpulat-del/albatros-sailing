        ...
        >
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "clamp(38px, 6vw, 60px)", lineHeight: 1.05, margin: "0 0 14px 0" }}>
              Coastal Skipper Programı
            </h1>

            <p style={{ maxWidth: "760px", fontSize: "18px", lineHeight: 1.8, opacity: 0.82, margin: 0 }}>
              Kıyı seyri, liman manevraları ve rota disiplinine geçiş için güçlü bir eğitim yapısı.
            </p>
          </div>
        </section>
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "28px" }}>
            ...
            >
              ...
              <p style={{ lineHeight: 1.75, opacity: 0.8 }}>
                Coastal Skipper, tekne üzerinde sorumluluk almaya başlayan
                katılımcılar için rota planlama, kıyı seyri, liman yaklaşmaları
                ve ekip koordinasyonu odaklıdır.
              </p>
              <p style={{ lineHeight: 1.75, opacity: 0.8 }}>
                Bu aşama, kaptanlık düşüncesine geçişte önemli eşiktir.
              </p>
            </div>
            ...
            >
              ...
              <p><strong>Süre:</strong> 4 Gün</p>
              <p><strong>Seviye:</strong> Orta Seviye</p>
              <p><strong>Odak:</strong> Kıyı seyri, rota takibi, liman manevraları</p>
              <p><strong>Uygunluk:</strong> Temel eğitim almış ve gelişmek isteyen katılımcılar</p>
            </div>
          </div>
        </section>
      </main>
