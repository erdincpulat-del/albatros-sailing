        ...
        >
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "clamp(38px, 6vw, 60px)", lineHeight: 1.05, margin: "0 0 14px 0" }}>
              Başlangıç Yelken Eğitimi
            </h1>

            <p style={{ maxWidth: "760px", fontSize: "18px", lineHeight: 1.8, opacity: 0.82, margin: 0 }}>
              Denizle ilk doğru tanışma, temel güvenlik bilgisi ve yelkenciliğe sağlam başlangıç.
            </p>
          </div>
        </section>
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "28px" }}>
            ...
            >
              ...
              <p style={{ lineHeight: 1.75, opacity: 0.8 }}>
                Bu program; temel yelken kavramları, tekne bölümleri, güvenlik,
                temel manevralar ve ekip çalışmasına giriş için tasarlanmıştır.
              </p>
              <p style={{ lineHeight: 1.75, opacity: 0.8 }}>
                Denizde ilk adımlarını kontrollü ve güvenli şekilde atmak
                isteyenler için doğru başlangıç seviyesidir.
              </p>
            </div>
            ...
            >
              ...
              <p><strong>Süre:</strong> 2 Gün</p>
              <p><strong>Seviye:</strong> Başlangıç</p>
              <p><strong>Odak:</strong> Temel güvenlik, ekip düzeni, başlangıç manevraları</p>
              <p><strong>Uygunluk:</strong> İlk kez yelken eğitimi alacak katılımcılar</p>
            </div>
          </div>
        </section>
      </main>
