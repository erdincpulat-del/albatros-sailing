...
function createFrontTextSvg({
  ...
  const fullNameFontSize = safeFullName.length > 28 ? 20 : safeFullName.length > 22 ? 22 : 24;
  const qualificationFontSize =
    safeQualification.length > 30 ? 20 : safeQualification.length > 24 ? 22 : 24;
...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="goldShimmer" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="15%" stop-color="rgba(255,255,255,0.00)"/>
      <stop offset="48%" stop-color="rgba(255,255,255,0.55)"/>
      <stop offset="52%" stop-color="rgba(255,255,255,0.82)"/>
      <stop offset="56%" stop-color="rgba(255,255,255,0.35)"/>
      <stop offset="85%" stop-color="rgba(255,255,255,0.00)"/>
    ...
    <linearGradient id="seaLine" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="25%" stop-color="rgba(17,56,101,0.16)"/>
      <stop offset="50%" stop-color="rgba(17,56,101,0.28)"/>
      <stop offset="75%" stop-color="rgba(17,56,101,0.16)"/>
  ...
  <g opacity="0.12">
    ...
    <path d="M560 280 L650 248 L755 286 L845 238 L955 296 L1060 252"
      fill="none" stroke="#60748a" stroke-width="1.3"/>
    <circle cx="560" cy="280" r="4" fill="#60748a"/>
    <circle cx="650" cy="248" r="4" fill="#60748a"/>
    <circle cx="755" cy="286" r="4" fill="#60748a"/>
    <circle cx="845" cy="238" r="4" fill="#60748a"/>
    <circle cx="955" cy="296" r="4" fill="#60748a"/>
    <circle cx="1060" cy="252" r="4" fill="#60748a"/>
  </g>
  ...
  <path
    d="M260 196 C360 180, 500 180, 610 196 S835 212, 945 196"
    fill="none"
    stroke="url(#goldSoft)"
    stroke-width="4.4"
    stroke-linecap="round"
...
>
  ...
  <text x="175" y="774" class="small">
    This certifies that the holder has successfully completed
  </text>
  <text x="175" y="804" class="small">
    the Offshore Yacht Course conducted by
  </text>
  ...
  <text x="175" y="860" class="school">
  Albatros Sailing School
</text>
...
<text x="175" y="900" class="location">
  Location: Muğla Bodrum, Turkey
</text>

  <text x="1008" y="542" class="meta">
    Official Albatros Sailing Record
  </text>
  <text x="1018" y="566" class="meta">
  ...
  <path
    d="M950 845 Q1060 806 1170 845 T1395 845"
    fill="none"
    stroke="url(#seaLine)"
    stroke-width="4.2"
    stroke-linecap="round"
  />
  <path
    d="M985 878 Q1095 838 1205 878 T1378 878"
    fill="none"
    stroke="url(#seaLine)"
    stroke-width="2.8"
    stroke-linecap="round"
  />
  <path
    d="M1025 905 Q1115 875 1205 905 T1355 905"
    fill="none"
    stroke="url(#seaLine)"
    stroke-width="1.8"
    stroke-linecap="round"
...
export async function generateCertificateCardFront({
  ...
  const height = metadata.height || 968;
  ...
  const textOverlay = createFrontTextSvg({
    width,
    height,
    fullName,
    qualification,
